...
public class MyThreadA extends Thread{
    ...
    public MyThreadA(MyThreadBuilder myThreadBuilder) {
        R = myThreadBuilder.R;
        G = myThreadBuilder.G;
        B = myThreadBuilder.B;
    ...
    public static class MyThreadBuilder {
        ...
        public MyThreadA build() {
            return new MyThreadA(this);
        }
    }
    ...
    public void run() {
            ...
            R = ImagesUtil.changeChannelByConvolutionBlur(R, convolutionMatrixBlur);
            G = ImagesUtil.changeChannelByConvolutionBlur(G, convolutionMatrixBlur);
            B = ImagesUtil.changeChannelByConvolutionBlur(B, convolutionMatrixBlur);
